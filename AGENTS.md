...
## Project Overview
**Project:** AI-Powered Business Finance Tracker
**** I wanna make a business finance tracker. It should help me track my expenses, income and assets for my business through a smart AI assistant powered by gpt 4.1. I should be able to provide the assistant my expense, income and asset or investment then it should be able to input to the database. There should also be a dashboard I can view the data and any insights that has been input by the AI.
...
---
*Generated by CodeGuide CLI on 2025-10-02T11:45:54.189Z*
